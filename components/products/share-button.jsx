...
export default function ShareButton() {
  ...
  return (
    <div className="relative max-[948]:mt-6">
      ...
      {showMenu &&
        <ul className="absolute top-17 min-w-40 text-left left-0 max-md:left-auto md:right-0 border border-stroke-a bg-black-d2 p-3 space-y-3 rounded-lg [&_a]:transition-colors [&_a]:duration-200 z-10">
