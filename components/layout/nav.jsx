...
export default function Nav() {
  ...
  return (
    <>
      ...
      <nav className={`[&_a]:inline-block [&_svg]:inline-block font-bold items-center ${showNav ? 'block absolute right-0 bg-gray-900 h-screen pt-15 p-6':'hidden'} md:h-auto md:pt-0 md:p-0 md:flex md:static md:bg-transparent`}>
